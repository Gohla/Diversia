...
void CampBindings::bindGameModePlugin()
{
    camp::Class::declare<GameModePlugin>( "GameMode" )
        ...
        .function( "Destroy script", &GameModePlugin::unload )
            .tag( "NoBitStream" )
            .tag( "QtPopupMenu" )
            .tag( "QtIcon", "" )
        .function( "Create script", &GameModePlugin::load )
            .tag( "NoBitStream" )
            .tag( "QtPopupMenu" )
            .tag( "QtIcon", "" )
...
void CampBindings::bindRigidBody()
{
    camp::Class::declare<RigidBody>( "RigidBody" )
        ...
        // Properties (read-only)
        // Properties (read/write)
        .property( "PhysicsType", &RigidBody::mPhysicsType, &RigidBody::setPhysicsType )
            .tag( "NoRestore" )
        .property( "Mass", &RigidBody::mMass, &RigidBody::setMass )
            .tag( "NoRestore" )
...
void CampBindings::bindLuaObjectScript()
{
    camp::Class::declare<LuaObjectScript>( "LuaObjectScript" )
        ...
        .property( "MousePriority", &LuaObjectScript::mMousePriority )
            .tag( "NoBitStream" )
        .property( "KeyboardPriority", &LuaObjectScript::mKeyboardPriority )
            .tag( "NoBitStream" )
        // Functions
        ...
        .function( "Create script", &LuaObjectScript::create )
            ...
            .tag( "QtPopupMenu" )
            .tag( "QtIcon", "" )
        .function( "CreateEnv", &LuaObjectScript::createEnv )
            .tag( "NoBitStream" )
        .function( "ReplaceVarWithThisEnv", &LuaObjectScript::replaceVarWithThisEnv )
            .tag( "NoBitStream" )
