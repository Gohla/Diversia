...
#ifndef DIVERSIA_OGRECLIENT_CANVAS_H
#define DIVERSIA_OGRECLIENT_CANVAS_H
...
* The Canvas.
*/
class DIVERSIA_OGRECLIENT_API Canvas : public Ogre::Renderable, public Ogre::MovableObject, public Ogre::RenderTargetListener
{
	struct Quad
	{
...
#endif // DIVERSIA_OGRECLIENT_CANVAS_H