...
#ifndef DIVERSIA_OGRECLIENT_ATLAS_H
#define DIVERSIA_OGRECLIENT_ATLAS_H
...
*/
class DIVERSIA_OGRECLIENT_API Atlas : public Ogre::ManualResourceLoader
{
...
#endif // DIVERSIA_OGRECLIENT_ATLAS_H